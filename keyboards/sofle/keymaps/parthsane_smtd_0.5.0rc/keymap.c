...
[_LOWER] = LAYOUT(
  ...
  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_LBRC,    KC_RBRC,    KC_BSLS,    KC_9,    KC_0,  KC_F12,
 ...
 *            `----------------------------------'           '------''---------------------------'
 */
// TODO Make copy past and undo based on OS
[_RAISE] = LAYOUT(
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |QK_BOOT|     |QWERTY|GAMING|TOGGLE|      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |MACWIN|      |      |      |-------.    ,-------|      | VOLDO| MUTE | VOLUP|      |      |
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |      |      |      |      |      |      |-------|    |-------|      | PREV | PLAY | NEXT |      |      |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |RAISE | RAlt | RGUI | RCTR |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
  [_ADJUST] = LAYOUT(
  XXXXXXX , XXXXXXX,  XXXXXXX ,  XXXXXXX , XXXXXXX, XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  QK_BOOT  , XXXXXXX,KC_QWERTY,KC_HRM,CG_TOGG,XXXXXXX,                     XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
...
smtd_resolution on_smtd_action(uint16_t keycode, smtd_action action, uint8_t tap_count) {
    if (keymap_config.swap_lctl_lgui) {
        switch (keycode) {
            ...
            SMTD_MT(KC_LSFT, KC_LSFT)
            SMTD_MT(KC_RSFT, KC_RSFT)
        }    
    } else {
        switch (keycode) {
