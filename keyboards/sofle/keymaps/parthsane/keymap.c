...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LCTL,KC_LGUI,KC_LALT, TL_LOWR, KC_SPC,        KC_ENT, TL_UPPR, KC_RALT, KC_RGUI, KC_RCTL
),
/*
 * HRM
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_HRM] = LAYOUT(
    KC_GRV,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_MINS,
    KC_ESC,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_BSPC,
    KC_TAB,   CKC_A,   CKC_S,    CKC_D,    CKC_F,    KC_G,                     KC_H,    CKC_J,    CKC_K,    CKC_L, CKC_SCLN,  KC_QUOT,
    KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
...
void on_smtd_action(uint16_t keycode, smtd_action action, uint8_t tap_count) {
    if (keymap_config.swap_lctl_lgui) {
        switch (keycode) {
            ...
            SMTD_MT(CKC_K, KC_K, KC_RIGHT_GUI)
            SMTD_MT(CKC_J, KC_J, KC_RSFT)
            SMTD_MT(KC_LSFT, KC_LSFT, KC_LSFT)
            SMTD_MT(KC_RSFT, KC_RSFT, KC_RSFT)
        }    
    } else {
        switch (keycode) {
